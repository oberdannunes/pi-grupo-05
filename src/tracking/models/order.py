...
class Order(models.Model):
    ...
    nfe = models.CharField(max_length=20, verbose_name='Número NFE', unique=True)
    ...
    carrier = models.ForeignKey('Carrier', on_delete=models.CASCADE, null=True, blank=True, verbose_name='Transportadora')
